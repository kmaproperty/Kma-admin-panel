import { Image } from "@/cp/lib/next-shim";
...
import { useCitySearch } from "@/cp/api/hooks/useCitySearch";
import { useEffect, useRef, useState } from "react";
import { useBuildingSearch } from "@/cp/api/hooks/useBuildingSearch";
import { useMutation, useQuery } from "@tanstack/react-query";
import { BhkResponse, getBhkApiHandler, getPropertyCategoryApiHandler, getPropertyListApiHandler, getPropertyTypeApiHandler, PropertyCategoryResponse, PropertyListResponse, PropertyTypePayload, PropertyTypeResponse } from "@/cp/services/masterService";
import { PropertyCategory, PropertyList, PropertyType } from "@/cp/types/postProperty";
import CustomOptionField from "../common/addCustomOption";
import { generateBHKAmeneties, generateBHKList } from "@/cp/lib/helper";
