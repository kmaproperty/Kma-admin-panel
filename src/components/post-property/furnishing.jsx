...
export default function Furnishing({open, onHide, dynamicFieldDetails, handleUpdateFurnishedCount, handleAddFurnished, furnishingList, setDynamicFieldDetails}) {
