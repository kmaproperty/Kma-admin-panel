...
export default function ListFilter({ filters, setFilters, statusData }) {
  ...
  return (
    <div className="bg-[#fff] rounded-[10px] px-[0.75rem] py-[1rem] h-fit w-[350px]">
      <div className="flex flex-col rounded-xl px-3 py-2 justify-start gap-5 w-full">
        {/* HEADER */}
        <div className="flex justify-between items-center w-full">
          <p className="font-semibold">Filter</p>
          <button
            className="px-3 py-1.5 rounded-lg text-sm flex items-center gap-1 cursor-pointer bg-red-100 text-red-800"
        ...
        {Array.isArray(propertyTypeList) && (
          <div className="text-text-gray">
            <p className="font-medium text-sm text-gray-800 mb-2">Service</p>
        ...
        {/* PRICE */}
        <div className="text-text-gray">
          <p className="font-medium text-sm text-gray-800 mb-2">Price</p>
